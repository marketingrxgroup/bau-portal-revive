...
export function SiteFooter() {
  return (
    <footer className="border-t border-border bg-ink text-ink-foreground">
      <div className="mx-auto max-w-[1480px] px-4 py-12 lg:py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            <h4 className="mb-5 text-sm font-bold uppercase tracking-wider">
              Информация
            </h4>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid gap-6">
              <div className="space-y-3">
                <p className="text-xs font-bold uppercase tracking-wider text-ink-foreground/50">
                  Нови машини
                </p>
                <a
                  href="tel:0879620220"
                ...
                <a
                  href="mailto:sales@bauportal.bg"
                  className="flex items-center gap-2 text-sm text-ink-foreground/70 hover:text-ink-foreground"
                >
              ...
              <div className="space-y-3">
                ...
                <a
                  href="mailto:complaint@bauportal.bg"
                  className="flex items-center gap-2 text-sm text-ink-foreground/70 hover:text-ink-foreground"
                >
                  <Mail className="h-4 w-4" />
                  complaint@bauportal.bg
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 lg:col-span-3">
            <div>
              ...
              <p className="mb-4 text-sm text-ink-foreground/60">
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-ink-foreground/70 hover:text-ink-foreground"
              >
